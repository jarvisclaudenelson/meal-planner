const url = 'https://hbykpslxdsojowellrim.supabase.co/rest/v1/recipes'
...
const sides = [
  {
    ...
    steps: ['Preheat oven to 400°F (200°C).', 'Toss broccoli with olive oil, garlic powder, salt, and pepper on a sheet pan.', 'Roast for 15-20 minutes until edges are crispy.', 'Drizzle with fresh lemon juice before serving.'],
  ...
  },
  {
    ...
    steps: ['Blanch green beans in boiling water for 3 minutes; drain and shock in ice water.', 'Heat oil and butter in a large skillet over medium-high heat.', 'Add beans and sauté for 2-3 minutes.', 'Add garlic and cook until fragrant (1 minute). Season and serve.'],
    tags: ['side', 'veggie', 'quick'],
    starred: false
  },
  {
    ...
    steps: ['Steam or boil carrots until tender (8-10 minutes). Drain.', 'In the same pan, melt butter and whisk in honey.', 'Add carrots back and toss over medium heat for 2-3 minutes until glazed.', 'Garnish with parsley.'],
